...
void custom_agg_renderer<T0, T1>::process(markers_symbolizer const& sym,
...
template void
  custom_agg_renderer<image_rgba8>::process(markers_symbolizer const&, mapnik::feature_impl&, proj_transform const&);
} // namespace mapnik
