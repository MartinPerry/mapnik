...
void custom_agg_renderer<T0, T1>::process(shield_symbolizer const& sym,
...
template void
  custom_agg_renderer<image_rgba8>::process(shield_symbolizer const&, mapnik::feature_impl&, proj_transform const&);
